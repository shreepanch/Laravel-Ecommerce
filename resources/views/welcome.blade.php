         ...
         @foreach($products as $key=>$product)
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <!-- <img class="img-fluid" src="{{ url('storage/products/'.$product->image) }}" alt=""> -->
              ...
              <div class="product-details">
                ...
                <div class="prd-bottom">
                  ...
                  <a href="{{ route('user.order.create', $product->id) }}" class="social-info">
                    <span class="ti-bag"></span>
                    <p class="hover-text">Place Order</p>
                  </a>
